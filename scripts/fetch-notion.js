  ...
  <main class="about-main">
    <div class="win w1">
      ...
      <div class="photo-body">
        ...
        <div class="photo-info">
          <h2>Emily</h2>
          <div class="role">Solution Planner · Writer · Creator</div>
    ...
    <div class="win w2">
      ...
      <div class="facts-body">
        <div class="fact"><div class="fact-num">01</div><div class="fact-text">是一介即將邁入30歲的巨蟹座女子</div></div>
        <div class="fact"><div class="fact-num">02</div><div class="fact-text">MBTI 是 ESFP 表演者，越熟越開心表演自己</div></div>
        <div class="fact"><div class="fact-num">03</div><div class="fact-text">大學、研究所都唸測量相關，但本人不耐曬，故默默選辦公室工作</div></div>
        ...
        <div class="fact"><div class="fact-num">06</div><div class="fact-text">人生終極夢想是開一間有個性的豆花店，搭配一隻宇宙可愛的店狗</div></div>
        <div class="fact"><div class="fact-num">07</div><div class="fact-text">有點怪的喜好是喜歡奇數、質數、開車</div></div>
        <div class="fact"><div class="fact-num">08</div><div class="fact-text">目前最想去的國家是紐西蘭</div></div>
